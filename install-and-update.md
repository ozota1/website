...
1. `/var/lib/kamonohashi/deploy-tools/1.1.6/rollback/rollback.sh`を実行します。
2. デプロイされているKAMONOHASHIのバージョンに`1.1.6`、戻したい時点のMigrationファイルに`20191113041648_v1.1.5`を入力します。
