...
1.1.5からバージョンダウンする場合の、DB切り戻しスクリプトの実行例
1. `/var/lib/kamonohashi/deploy-tools/1.1.5/rollback/rollback.sh`を実行します。
2. デプロイされているKAMONOHASHIのバージョンに`1.1.5`、戻したい時点のMigrationファイルに`20190911075454_v1.1.3`を入力します。
