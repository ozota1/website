...
|コンテナイメージ|任意|利用するDockerレジストリ、コンテナ、タグを指定する。未指定の場合は、デフォルト値として[Docker Hub](https://hub.docker.com/r/tensorflow/tensorflow)に公開されているtensorflow/tensorflow:1.15.2-gpuが利用される。|
